...
module.exports = {
    ...
    async execute(interactionOrMessage) {
        ...
        // ... (Yetki ve Kontroller Aynı Kaldı) ...
        const isAuthorized =
        ...
        try {
            // Sadece sicil kaydını ekle (medkayit.siciller)
            ...
            setTimeout(async () => {
                try {
                    ...
                    // Kanal ve log kanalına unmute bildirimi
                    await channel.send({ embeds: [unmuteEmbed] });
                    if (logChannel) {
                        await logChannel.send({ embeds: [unmuteEmbed] });
                    }
                } catch (timeoutError) {
                    console.error('Mute kaldırma işlemi sırasında hata oluştu (setTimeout):', timeoutError);
                }
