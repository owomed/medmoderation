...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        üye.voice.setMute(true), message.reply(`\`Etiketlenen üye başarıyla ses kanallarında (${süre}) boyunca susturuldu!\``).then(x => x.delete({ timeout: 9000 }), message.react(id.Emojiler.başarılıemojiid))
